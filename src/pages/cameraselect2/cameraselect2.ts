      ...
      (window as any).resolveLocalFileSystemURL("file://"+results,FE=>{
        ...
        FE.file(file=>{
          ...
          FR.onloadend=((res:any)=>{
            ...
            console.log(blob);
            firebase.storage().ref().child("videos").child(this.key).child("video"+this.v).put(blob).then((e)=>{
              firebase.storage().ref().child("videos").child(this.key).child("video"+this.v).getDownloadURL().then((url)=>{
